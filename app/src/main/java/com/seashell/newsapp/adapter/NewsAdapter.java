package com.seashell.newsapp.adapter;
...
import com.seashell.newsapp.R;
import com.seashell.newsapp.databinding.ItemNewsBinding;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.NewsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NewsViewHolder holder, int position) {
      NewsData nd= newsDataList.get(position);
        ...
        Picasso.get().load(nd.getImgUrl()).into(holder.binding.ImageNews);
    }
